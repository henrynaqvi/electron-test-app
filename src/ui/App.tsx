...
function App() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <h1 className="bg-gray-700 text-white text-center p-2">
        Welcome to your profile
      </h1>
      <div className="app grow flex flex-col">
        <header className="app-header">
          ...
          <div className="app-header-navigation">
            {tab === 0 && (
              <>
                <div className="tabs">
                  <button
                    className={`${
                      isOpen === 0 ? "text-white border-white" : ""
                    }`}
                    type="button"
                    onClick={() => setIsOpen(0)}
                  >
                  ...
                  <button
                    className={`${
                      isOpen === 1 ? "text-white border-white" : ""
                    }`}
                    type="button"
                    onClick={() => setIsOpen(1)}
                  >
                  ...
                  <button
                    className={`${
                      isOpen === 2 ? "text-white border-white" : ""
                    }`}
                    type="button"
                    onClick={() => setIsOpen(2)}
                  >
            ...
            {tab === 1 && (
              <>
                <div className="tabs">
                  <p className="text-lg text-white mb-2">Users</p>
                </div>
              </>
            )}
          </div>
          <div className="app-header-actions">
            <button className="user-profile">
              ...
              <span className="w-[30px] h-[30px] bg-gray-400">
              </span>
            </button>
          </div>
        ...
        <div className="app-body grow">
          <div className="app-body-navigation">
            <nav className="navigation">
              ...
              >
                <span className={`${tab === 0 ? "text-white" : ""}`}>
                  Dashboard
                </span>
              </button>
              <button
                ...
                className="cursor-pointer"
              >
                <span className={`${tab === 1 ? "text-white" : ""}`}>Users</span>
              </button>
              {/*<a href="#">
